...
## Доработки
В коде есть заглушки для реализации проверок шаблонов ВКР. Это может быть относительно безболезненно реализовано, равно как и проверки отчетов по лабам, и проч., и проч. Фронтенд также может быть улучшен, необходима адаптивная верстка, оптимизация под мобильные устройства.
